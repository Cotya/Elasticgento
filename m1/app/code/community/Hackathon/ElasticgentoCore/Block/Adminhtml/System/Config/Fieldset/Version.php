 ...
 *
 */
class Hackathon_ElasticgentoCore_Block_Adminhtml_System_Config_Fieldset_Version extends Mage_Adminhtml_Block_Abstract implements Varien_Data_Form_Element_Renderer_Interface
{
    /**
